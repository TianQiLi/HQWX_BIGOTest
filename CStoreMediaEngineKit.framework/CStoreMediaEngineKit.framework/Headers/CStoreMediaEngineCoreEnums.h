...
/**
 渲染模式
 */
typedef NS_ENUM(uint8_t, CSMVideoRenderMode) {
    /**
     类似于iOS UIViewContentModeScaleAspectFit
     */
    CSMVideoRenderModeFitCenter      = 0,
    /**
     类似于iOS UIViewContentModeScaleAspectFill
     */
    CSMVideoRenderModeCenterCrop    = 1,
...
typedef NS_ENUM(int, CSMErrorCode) {
    ...
    /**
     设置角色失败
     */
    CSMErrorSetClientRoleFailed = -20,
};
...
/*
 视频旋转横竖屏模式
 */
typedef NS_ENUM(NSInteger, AestronVideoOrientation) {
    AestronVideoOrientation0 = 0,
    AestronVideoOrientation90 = 1, //逆时针转90°
    AestronVideoOrientation180 = 2,//逆时针转180°
    AestronVideoOrientation270 = 3,//逆时针转270°
};
 ...
 * 水印设置错误码
 */
typedef NS_ENUM(NSInteger, AestronWaterMarkResCode) {
    AestronWaterMarkResCode_Fail  = -1,     // 失败
    AestronWaterMarkResCode_Success = 0,    // 成功
};

/**
 日志上传错误码
 */
typedef NS_ENUM(NSInteger, CSMErrorUploadLogErrorCode) {
    /**
     成功
     */
    CSMErrorUploadLogErrorCodeSuccess = 0,
    /**
     日志上传无网络
     */
    CSMErrorUploadLogErrorCodeNetworkUnavialiable = 1,

    /**
     日志上传获取token失败
     */
    CSMErrorUploadLogErrorCodeGetTokenError = 2,

    /**
     日志上传文件失败
     */
    CSMErrorUploadLogErrorCodeUploadFileFailed = 3,

    /**
     日志上传信息上报失败
     */
    CSMErrorUploadLogErrorCodeReportFailed = 4,
    
    /*
     日志正在上传中
     */
    CSMErrorUploadLogErrorCodeUploading = 5,
    /*
     日志上传关闭
     */
    CSMErrorUploadLogErrorCodeDisableUpload = 6,
};
